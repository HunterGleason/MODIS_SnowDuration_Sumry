##############################################################################################
#Code for summarising M*D10A1 snow duration data of Bevignton et al. (2018)
#Hunter Gleason
#FLNRORD
#Dec 18, 2019
##############################################################################################
...
nrd_plt <- ggplot() + geom_sf(data = nrd)+geom_sf_label(data=nrd,aes(label = rnum)) + labs(y='Lat.', x = 'Lon.')
nrd_plt
...
##############################################################################################
#Get boot straped CI's for summary stats 
##############################################################################################
...
#Plot summary results by NRD using ggplot2
...
#Generate boxplots of snow metrics by hydrologic year
